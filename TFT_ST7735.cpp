...
********************  Text Functions *********************
**********************************************************/
void TFT_ST7735::setCursor(int16_t x, int16_t y,enum ST7735_centerMode c) 
{
...
*/
void TFT_ST7735::_glyphRender_unc(
...
*/
void TFT_ST7735::_charLineRender(
									bool 			lineBuffer[],
									int 			charW,
									int16_t 		x,
									int16_t 		y,
